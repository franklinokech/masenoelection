    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if ((!"".equals(txtRegNo.getText())) && (!"".equals(txtFname.getText())) && (!"".equals(txtMname.getText())) && (!"".equals(txtSname.getText()))
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Invalid registration number,Please review", "Invalid data", JOptionPane.ERROR_MESSAGE);
                txtRegNo.requestFocus();
            } catch (com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException e) {
                JOptionPane.showMessageDialog(null, "Duplicate entry not allowed!", "ERROR", JOptionPane.ERROR_MESSAGE);
            } catch (SQLException ex) {
